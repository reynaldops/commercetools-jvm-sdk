...
A {@link CustomObject} contains an ID, a version, timestamps
like the other resources in the platform and in addition {@link CustomObject#getContainer()},
{@link CustomObject#getKey()} and {@link CustomObject#getValue()}.
...
For update operations you can use {@link io.sphere.sdk.customobjects.CustomObjectDraft#ofVersionedUpdate(CustomObject, Object, com.fasterxml.jackson.core.type.TypeReference)}
...
Or you can just override the value using {@link io.sphere.sdk.customobjects.CustomObjectDraft#ofUnversionedUpdate(CustomObject, Object, com.fasterxml.jackson.core.type.TypeReference)}
