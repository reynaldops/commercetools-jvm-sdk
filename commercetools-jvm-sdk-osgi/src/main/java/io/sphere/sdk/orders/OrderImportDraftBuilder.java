...
public final class OrderImportDraftBuilder extends Base implements Builder<OrderImportDraft> {
     ...
     * You can add {@link io.sphere.sdk.carts.CustomLineItem}s with {@link #customLineItems(List)}.
     *
     ...
     * You can add {@link io.sphere.sdk.carts.LineItem}s with {@link #lineItems(List)}.
     *
     * @param totalPrice the total price of the order
     * @param orderState the state of the order
